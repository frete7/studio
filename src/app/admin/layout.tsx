...
import { Home, Users, Truck, Package, Settings, PanelLeft, CreditCard, Shapes, Type, Container } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/body-types', label: 'Carrocerias', icon: Container },
