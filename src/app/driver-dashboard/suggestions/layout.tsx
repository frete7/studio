...
import { Home, Search, User, FileText, ClipboardList, LayoutDashboard, MessageSquareWarning } from "lucide-react";
...
const navItems = [
    ...
    { href: '/driver-dashboard/suggestions', label: 'Sugestões', icon: MessageSquareWarning },
